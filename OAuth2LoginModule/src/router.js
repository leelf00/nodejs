...
module.exports._cache_server_urls = [];
module.exports._whitelist = [];
module.exports._menulist = [];

module.exports.urlrouter = (requrl,result) => {
...
module.exports.refresh = () => {
	Promise.all([mysqlClient.getRouterMap({}),mysqlClient.getWhitelist([]),mysqlClient.getMenuList([])]).then(v=>{
		this._cache_server_urls = v[0];
		this._whitelist = v[1];
		this._menulist = v[2];
	});
}
